...
* The original package name 'com.example.alarm-server' is invalid and this project uses 'com.example.alarmserver' instead.
...
```
$ docker run --rm -p 8080:8080 alarm-server:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/alarm-server
```
