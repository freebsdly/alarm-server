...
import com.example.alarmserver.DemoApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.example.alarmserver.DemoApplicationTests", () -> new DemoApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.example.alarmserver.DemoApplicationTests", DemoApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
